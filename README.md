...
> Стадия: **Этап 0 — walking skeleton** (живой health-эндпоинт по домену). Роадмап — `PLAN.md`,
> правила/инварианты/агенты — `CLAUDE.md`.
...
eval/       метрики качества (заводятся с Этапа 1)
```
