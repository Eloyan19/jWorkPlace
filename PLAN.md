...
> ⏸ **ОТЛОЖЕН (решение пользователя 2026-07-20).** MVP 0–3 + доработки задеплоены; рой берём позже.
> Сейчас проходимся по нюансам/доработкам текущего продукта. Дизайн-гипотеза ниже сохранена.
